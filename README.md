...
## What is Hydrafiles?
Hydrafiles is the headless storage network. Anyone can be a part of the network. Hydrafiles allows for files to be hosted anonymously in the Hydra cloud, where no one knows what's hosted where.
