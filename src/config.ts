import untypedDefaultConfig from "../config.default.json" with { type: "json" };
...
const getConfig = (config: Partial<Config> = {}): Config => {
  return {
    ...
    metadata_endpoint: config?.metadata_endpoint ??
      defaultConfig.metadata_endpoint,
    ...
    memory_threshold: config?.memory_threshold ??
      defaultConfig.memory_threshold,
    memory_threshold_reached_wait: config?.memory_threshold_reached_wait ??
      defaultConfig.memory_threshold_reached_wait,
