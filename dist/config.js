...
const getConfig = (config = {}) => {
    ...
    return {
        ...
        upload_secret: (_k = config === null || config === void 0 ? void 0 : config.upload_secret) !== null && _k !== void 0 ? _k : defaultConfig.upload_secret,
        memory_threshold: (_l = config === null || config === void 0 ? void 0 : config.memory_threshold) !== null && _l !== void 0 ? _l : defaultConfig.memory_threshold,
        memory_threshold_reached_wait: (_m = config === null || config === void 0 ? void 0 : config.memory_threshold_reached_wait) !== null && _m !== void 0 ? _m : defaultConfig.memory_threshold_reached_wait,
        timeout: (_o = config === null || config === void 0 ? void 0 : config.timeout) !== null && _o !== void 0 ? _o : defaultConfig.timeout,
        log_level: (_p = config === null || config === void 0 ? void 0 : config.log_level) !== null && _p !== void 0 ? _p : defaultConfig.log_level,
        summary_speed: (_q = config === null || config === void 0 ? void 0 : config.summary_speed) !== null && _q !== void 0 ? _q : defaultConfig.summary_speed,
        compare_speed: (_r = config === null || config === void 0 ? void 0 : config.compare_speed) !== null && _r !== void 0 ? _r : defaultConfig.compare_speed,
        backfill: (_s = config === null || config === void 0 ? void 0 : config.backfill) !== null && _s !== void 0 ? _s : defaultConfig.backfill,
        compare_nodes: (_t = config === null || config === void 0 ? void 0 : config.compare_nodes) !== null && _t !== void 0 ? _t : defaultConfig.compare_nodes,
        compare_files: (_u = config === null || config === void 0 ? void 0 : config.compare_files) !== null && _u !== void 0 ? _u : defaultConfig.compare_files,
