...
- **No File System:** Websites are unable to access your filesystem. Some browsers support FileSystem API, which solves this. But [support is lackluster](https://caniuse.com/?search=showDirectoryPicker) with only
